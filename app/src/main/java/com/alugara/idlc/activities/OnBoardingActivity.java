...
import com.alugara.idlc.preferences.PrefManager;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.onboard_one,
                R.layout.onboard_two,
                R.layout.onboard_three};
    ...
    private void addBottomDots(int currentPage) {
        ...
        int colorsInactive = getResources().getColor(R.color.gray);
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getResources().getString(R.string.string_mulai));
                btnSkip.setVisibility(View.GONE);
            } else {
                // still pages are left
                btnNext.setText(getResources().getString(R.string.string_selanjutnya));
